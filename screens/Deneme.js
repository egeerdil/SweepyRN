...
export default class PersonList extends React.Component {
  ...
  componentDidMount() {
    axios
      .get('https://sweepy-dev.herokuapp.com/lottery/getAllLotteriesNoLogin')
      .then((res) => {
...
<Left><TouchableOpacity  onPress={() => this.props.navigation.navigate("Menu")}>
  ...
  />
          ...
          <Body >
            <Title  style={{backgroundColor: '#FDB4B4',color:'black', textAlign:'center'}}>AnaSayfa</Title>
          </Body>
<Right>
  <TouchableOpacity
   >
          ...
          <ScrollView>
            <View
              ...
              <Text
                ...
                {' '}Anasayfada ekibimiz tarafindan en cok begenilmis cekilisler ana
                sayfada gosterilmektedir</Text>
            </View>
