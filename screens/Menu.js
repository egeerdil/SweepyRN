    ...
    return (
      <View style={{flex: 1, backgroundColor: '#F1F1F1'}}>
        <Header style={{backgroundColor: '#FDB4B4', textAlign:'center'}}>
          ...
          <Body >
            <Title  style={{backgroundColor: '#FDB4B4',color:'black', textAlign:'center'}}>Bilgilendirme</Title>
          </Body>
          ...
          <ScrollView>
            ...
            <View
              ...
              <Text
                ...
                {' '}
                Sweepy, çeşitli kurum veya kişilerin düzenlediği çekilişleri tek bir platformda görebilmen ve çekilişlere kolayca ulaşabilmen için tasarlandıç Kategorilere göre fildrelediğimiz çekilişleri favorilerine ekle ve kendi listeni oluşturç Çekilişlere ulaşmak hiç bu kadar kolay olmamıstı.{' '}
              </Text>
            </View>
          </ScrollView>
        </SafeAreaView>
